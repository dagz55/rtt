...
class AppManager:
    ...
    def view_logs(self) -> None:
        ...
        log_commands = {
            "1": f"brew services logs mongodb/brew/mongodb-community@7.0 | tail -n 50",
            "2": f"tail -n 50 {self.server_dir}/logs/server.log",
            "3": f"tail -n 50 {self.client_dir}/logs/client.log"
        }
        
        try:
            os.system(log_commands[choice])
